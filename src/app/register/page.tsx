...
export default function RegisterPage() {
  ...
  const marketingTexts = [
    "Manage assets at the speed of thought.",
    "The modern infrastructure for your brand.",
    "AI-powered discovery for creative teams.",
    "Seamless collaboration, elite organization.",
    "Powering the next generation of DAM."
  ];
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 sm:p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none">
              ...
              <div className={clsx(
                ...
                {error.toLowerCase().includes('confirm') ? (
                  <div className="flex flex-col gap-1">
                    ...
                    <span>Please check your inbox to confirm your account and get started.</span>
                  </div>
                ) : error}
              </div>
            )}
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 mt-2 font-bold text-white bg-indigo-600 hover:bg-indigo-500 rounded-xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 disabled:opacity-50 transition-all active:scale-[0.98] shadow-lg shadow-indigo-600/20"
              >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 border border-zinc-200 dark:border-zinc-800 rounded-xl hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all font-semibold text-zinc-700 dark:text-zinc-300 active:scale-[0.98]"
            >
