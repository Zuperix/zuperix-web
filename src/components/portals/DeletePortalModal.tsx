...
export default function DeletePortalModal({ 
  isOpen, 
  onClose, 
  onConfirm, 
  portalName 
      ...
      <div className="relative w-full max-w-md bg-gray-950 border border-gray-800 rounded-[32px] shadow-2xl overflow-hidden animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
        <div className="p-8 space-y-6">
          ...
          <div className="space-y-2">
            <h3 className="text-xl font-black text-white uppercase tracking-tight">Delete Portal</h3>
            <p className="text-sm text-gray-500 leading-relaxed font-medium">
              Are you sure you want to delete <span className="text-white font-bold">"{portalName}"</span>? 
              This action cannot be undone and all public access will be revoked immediately.
            </p>
          </div>
